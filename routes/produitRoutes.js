...
router.put('/put_varianteProduit/:id', putVariantProduit);
...
router.get('/mouvement_rapportEncours', getMouvementEncoursRapports)
router.get('/mouvement_rapportVente', getMouvementVenteRapports)
